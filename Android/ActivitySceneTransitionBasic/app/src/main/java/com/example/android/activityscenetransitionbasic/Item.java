...
public class Item {
    ...
    private static final String LARGE_BASE_URL = "https://avatar.csdn.net/4/E/8/";
    private static final String THUMB_BASE_URL = "https://avatar.csdn.net/4/E/8/";
    ...
    public static Item[] ITEMS = new Item[] {
            new Item("Flying in the Light", "Romain Guy", "1_y1scp.jpg"),
            new Item("Caterpillar", "Romain Guy", "1_y1scp.jpg"),
            new Item("Look Me in the Eye", "Romain Guy", "1_y1scp.jpg"),
            new Item("Flamingo", "Romain Guy", "1_y1scp.jpg"),
            new Item("Rainbow", "Romain Guy", "1_y1scp.jpg"),
            new Item("Over there", "Romain Guy", "1_y1scp.jpg"),
            new Item("Jelly Fish 2", "Romain Guy", "1_y1scp.jpg"),
            new Item("Lone Pine Sunset", "Romain Guy", "1_y1scp.jpg"),
    };
